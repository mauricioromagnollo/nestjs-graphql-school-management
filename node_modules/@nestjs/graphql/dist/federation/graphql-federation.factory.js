...
let GraphQLFederationFactory = class GraphQLFederationFactory {
    ...
    async generateSchema(options) {
        const { buildSubgraphSchema, printSubgraphSchema } = (0, load_package_util_1.loadPackage)('@apollo/subgraph', 'ApolloFederation', () => require('@apollo/subgraph'));
